...
- `git clone https://github.com/tryber/sd-0x-restaurant-orders-rubric2.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `sd-0x-restaurant-orders-rubric2`
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-0x-restaurant-orders-rubric2/pulls)
